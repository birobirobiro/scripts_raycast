...
// Documentation:
// @raycast.description Toggle Estante
...
// console.log(devices);
 ...
 /* toggle device */
 await connection.toggleDevice('1000c0d55e');

 const status = await connection.getDevicePowerState('1000c0d55e');
